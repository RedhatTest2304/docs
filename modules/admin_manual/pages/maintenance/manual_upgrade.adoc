...
ownCloud's xref:installation/manual_installation#install-the-required-packages[mandatory requirements] (such as PHP versions and extensions) can change from one version to the next.
